...
for i in range(iterations):
    ...
    outputToFile(hillClimber.newSchedule, f"Nederland; 1000 runs; hillclimber die stopt na 1000000. 25/06/2024 run_{i + 1}", "data/hillclimberNederlandOutput_new.csv")
    routesToFile(hillClimber.newSchedule, f"Nederland, 1000 runs, hillclimber die stopt na 1000000. 25/06/2024 run_{i + 1}", "data/hillclimberNederlandRoutes_new.csv")
    outputHillClimberGraph(hillClimber.iterations_listPoints, hillClimber.scoresPoints, hillClimber.iterations_list, hillClimber.scores, f"Nederland, 1000 runs, hillclimber die stopt na 1000000. 25/06/2024  run_{i + 1}", "data/hillclimberNederlandGraph_new.csv")
    scoresToFile(hillClimber.newSchedule, i, "data/hillclimberNederlandScores_new.csv")
    
    print(hillClimber.newSchedule.generate_output())
